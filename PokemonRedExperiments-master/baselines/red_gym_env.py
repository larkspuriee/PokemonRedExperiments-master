...
class RedGymEnv(Env):
    ...
    # Initializes the PyBoy emulator and prepares the environment for the RL agent.
    def __init__(
        self, config=None):
    ...
    # Initializes a k-nearest neighbors (KNN) index to track unique frames for exploration rewards.
    def init_knn(self):
        # Declaring index
    ...
    # Generates the current game screen as an observation for the RL agent
    ...
    # Executes the given action in the emulator
    # Checks if the episode is done and returns the next observation, reward, and termination flag
    ...
    # Sends a specific action (button press) to the emulator
    ...
    # Records detailed agent stats (e.g., position, party size, levels, badges) for debugging and analysis
    ...
    # Updates the KNN exploration memory with new frames if they are sufficiently different from previously visited frames
    ...
    # Updates coordinate-based exploration memory with the agent’s current position
    ...
    # Computes the reward for the current step by comparing progress to the previous step
    ...
    # Groups and scales rewards for various categories like exploration, levels, and health
    ...
    # Generates a visual representation of the agent’s exploration progress
    ...
    # Creates a visual representation of the agent’s short-term memory
    ...
    # Determines if the episode should end based on step count, early stopping, or other conditions
    def check_if_done(self):
        ...
        return done
    # Saves debugging information, screenshots, and videos when the episode ends.
    ...
    # Reads a memory value from the emulator
    ...
    # Computes the total level of all Pokémon in the party.
    ...
    #Calculates the exploration reward based on KNN memory
    ...
    # Tracks the highest opponent level encountered
